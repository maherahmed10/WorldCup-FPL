...
(function(){
  ...
  function PlayerRow({p, variant='pick', onPick, picked, disabled, reason}){
    return React.createElement('button',{
        className:'prow'+(picked?' picked':'')+(disabled?' disabled':''),
        onClick: ()=> !disabled && onPick && onPick(p), disabled,
      ...
      variant==='pick' && React.createElement('div',{className:'prow-action'},
